...
The following is a collection of documents written over the course of the project in close to their original form. They are here to give perspective on the progress made on this project throughout the year. The documents included are the Requirements Document, the Design Document, the Technology Review, and the Expo Poster.
...
\newline\textbf{Figure 5.1} SSD Bounding Boxes
\newline\newline
