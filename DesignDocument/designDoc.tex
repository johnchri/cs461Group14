...
\newline
\begin{figure}
  \includegraphics[natwidth=100,natheight=85]{GoogLeNetModule.eps}
...
\begin{figure}
  \includegraphics[natwidth=100,natheight=120]{pseudocode.eps}
...
\newline
\begin{figure}
  \includegraphics[natwidth=100,natheight=200]{design.eps}
