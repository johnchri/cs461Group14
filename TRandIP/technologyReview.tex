...
On further review, we've discovered that GoogLeNet is the backbone design of the Caffe based SSD we're using.
While we are not fully using GoogLeNet as it was originally designed, it's design still heavily contributes to how our network runs.
